...
public class Driver2 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		stateWiseCount.setJarByClass(Driver2.class);

		/* Field separator for reducer output*/
		stateWiseCount.getConfiguration().set("mapreduce.output.textoutputformat.separator", " | ");
		
		stateWiseCount.setMapperClass(NumUIDMapper2.class);
		stateWiseCount.setReducerClass(NumUIDReducer2.class);
		...
		sort.setJarByClass(Driver2.class);		
		...
		sort.setSortComparatorClass(SortComparator2.class);
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new Driver2(), args);
	}
