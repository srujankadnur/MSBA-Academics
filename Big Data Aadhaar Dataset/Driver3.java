...
public class Driver3 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		stateWiseCount.setJarByClass(Driver3.class);

		/* Field separator for reducer output*/
		stateWiseCount.getConfiguration().set("mapreduce.output.textoutputformat.separator", " | ");
		
		stateWiseCount.setMapperClass(NumUIDMapper3.class);
		stateWiseCount.setReducerClass(NumUIDReducer3.class);
		...
		sort.setJarByClass(Driver3.class);		
		
		sort.setOutputKeyClass(Text.class);
		sort.setOutputValueClass(IntWritable.class);

		sort.setMapperClass(SortMapper3.class);
		sort.setReducerClass(SortReducer3.class);
		sort.setSortComparatorClass(SortComparator3.class);
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new Driver3(), args);
	}
